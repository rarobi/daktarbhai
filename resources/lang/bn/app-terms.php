...
return
    [
        ...
        'definition_section' =>
            [
                ...
                'daktarbhai_description' => 'is a service provider that bridges between healthcare seekers and healthcare service providers.',
                'content'                => '"Content"',
                ...
                'services'               => '"Services"',
                'services_description'   => 'means services provided through the Daktarbhai.',
        ...
        'service_section' =>
            [
                'title'           => 'Daktarbhai Contents and Services',
                ...
                'sub_title_2'     => 'Daktarbhai, for Personal use',
                ...
                'sub_title_3'     => 'Daktarbhai does not make Recommendations',
                'description_4'   => 'Daktarbhai does not recommend any specific contents, services, tests, products, procedures, opinions or other information. We can only help you with storing medical data and to choose doctors and hospitals. A member will make the final decision on the choice of hospitals and doctors. ',
            ],

        'membership_terms_section' =>
            [
                'title'       => 'Membership Terms and Termination',
                'description' => 'After registration, you can start enjoying the privileges of Daktarbhai membership. You may cancel your membership at any time. Please email or contact us by calling at call center, if you wish to cancel your membership. Your membership benefits are not transferable and are for your own personal use only. Daktarbhai reserves the right to cancel your membership at any time.',
            ],
        ...
        [
            ...
            'description_1'  => 'Daktarbhai is designed to support most healthcare decisions of its members and help them make choices on health related decisions. These decisions and choices are at the end yours and Daktarbhai believes that you are the best decision maker of your health. Decisions you are making, have to be aligned with the advices you receive from a professional doctor of your choice. You have to take your own decision and Daktarbhai can not make decisions for you, we can only guide you towards it',
            'sub_title_2'    => 'Doctor-Patient Relationship',
            'description_2'  => 'The use of Daktarbhai will not create a doctor-patient relationship; however, it will help doctors to take fast and reliable decisions. Daktarbhai contains members limited personal contents that may help a member identify services or the AI of the application may offer services to the member. Everything on Daktarbhai, including contents accessed or services provided through us, are for your information and usage, which should be used by users for informational purpose only.',
            ...
            'description_4'  => 'If you want to unsubscribe our services, you can use Daktarbhai app and follow the instructions to unsubscribe or dial the hotline number',
            'description_5'  =>'Consult us, if there is any kind of health related issues with our service by contacting us through our call center number',
            'send_email' =>'or send us an email to ',
            'info_dakatarbhai'=>   'info@daktarbhai.com' ,
    ...
    'membership_renewal_section' => [
        ...
        'member_responsibility'  => [
            ...
            'responsibility_4' => 'Show your membership card, the member ‘E-Card’ or eligibility SMS at panel hospitals/diagnostic centers/pharmacies/healthy lifestyle outlets to receive membership benefits. ',
            'responsibility_5' => 'Understand your health condition and work with your doctor to develop treatment goals that you both agree upon.',
    ...
    'e-phr' => [
        'title'         => 'Members’ Personal Health Record (e-PHR)',
        ...
        'tips'=> [
            ...
            'tips_1'        => 'Make sure every new doctor you visit is given a copy of your healthcare record which is easily printable from your member’s portal.',
        ...
        'life_insurance' => [
            ...
            'exemption_health_insurance' => [
                ...
                'description'   => 'No benefit shall be paid under this Contract for expenses or losses resulting from or incurred in connection with or in consequence of the following:',
    ...
    'user_section' => [
        ...
        'legal_purpose' => [
            ...
            'description'   => 'Daktarbhai will use your personal information in a secured manner. Daktarbhai has implemented various encryption and security technologies and some procedures to protect you from unauthorized access. You are completely responsible for the access of your username and password. Daktarbhai reserves the right to revoke or deactivate your username and password at any time.',
        ],
        'acceptance_terms' => [
