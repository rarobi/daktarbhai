...
<div class="wrapper rounded6" id="templateContainer">
    ...
    <div id="templateBody" class="bodyContent rounded6">
        <form class="form" method="get" action="{{ route('frontend.deactive-email', ['random_key' => $emailSubscriber->random_key] ) }}">
            <div class="form-group">
                <label for="exampleInputEmail1">Email address</label>
                <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" readonly value="{{ $emailSubscriber->email }}">
                <small id="emailHelp" class="form-text text-muted">Are You Sure To Unsubscribe  New HealthTips Notificatios?</small>
            </div>
