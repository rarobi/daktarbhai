...
@section('main-content')
    ...
    <!-- ————————————————————————————————————————————
            ———	Phr Content
            —————————————————————————————————————————————— -->
    <h3 class="phr-title">{{__('phr.glucose.list_title')}}</h3>
    ...
    <div class="table-responsive phr-table">
        <table id="example" class="mdl-data-table" width="100%" cellspacing="0">
            ...
            <tr>
                ...
                <th>{{__('phr.glucose.table.title.type')}}</th>
                <th>{{__('phr.glucose.table.title.value')}}</th>
                <th>{{__('phr.glucose.table.title.day_time')}}</th>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="{!! route('frontend.phr.show', ['phr' => 'glucose', 'id'=> $list->id]) !!}">
