...
{{--{!! dd($logged_in_api_user->is_subscribed) !!}--}}
    ...
    <div class="row no-margin grey-bg">
      ...
      <div class="col-md-5 padding-leftright-null">
        <div class="text padding-md-bottom-null cor-pack">
          <h3>{{__('premium.section_4.title')}} </h3>
          <p class="m-b-15px">{{__('premium.section_4.description')}}
          </p>
          @if(Cookie::has('_tn') && isset($logged_in_api_user) && $logged_in_api_user->is_subscribed)
            <a href="{!! route('frontend.insurance-claim') !!}" class="premium-btn">{{__('premium.section_4.button')}}</a>
          @else
            <a href="{!! route('frontend.subscription.plan') !!}" class="premium-btn">{{__('premium.upgrade')}}</a>
          @endif
    ...
    <div class="row no-margin">
      <div class="col-md-5 padding-leftright-null col-md-offset-1">
        <div class="text padding-md-bottom-null cor-pack">
          <h3>{{__('premium.section_5.title')}}</h3>
          <p class="m-b-15px">{{__('premium.section_5.description')}}
          </p>
          @if(Cookie::has('_tn') && isset($logged_in_api_user) && $logged_in_api_user->is_subscribed)
            <a href="{!! route('frontend.insurance-claim') !!}" class="premium-btn">{{__('premium.section_5.button')}}</a>
          @else
            <a href="{!! route('frontend.subscription.plan') !!}" class="premium-btn">{{__('premium.upgrade')}}</a>
          @endif
          <a href="{!! route('frontend.health-insurance') !!}" class="premium-btn">{{__('premium.learn_more')}}</a>
    ...
    <div class="row no-margin grey-bg">
      ...
      <div class="col-md-5 padding-leftright-null">
        <div class="text padding-md-bottom-null cor-pack">
          <h3>{{__('premium.section_6.title')}} </h3>
          <p class="m-b-15px">{{__('premium.section_6.description')}}
          </p>
          @if(Cookie::has('_tn') && isset($logged_in_api_user) && $logged_in_api_user->is_subscribed)
            <a href="{!! route('frontend.insurance-claim') !!}" class="premium-btn">{{__('premium.section_6.button')}}</a>
          @else
            <a href="{!! route('frontend.subscription.plan') !!}" class="premium-btn">{{__('premium.upgrade')}}</a>
          @endif
          <a href="{!! route('frontend.health-insurance') !!}" class="premium-btn">{{__('premium.learn_more')}}</a>
