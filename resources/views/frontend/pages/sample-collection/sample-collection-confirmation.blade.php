...
{{--                                    <h3 class="grey big margin-bottom-small">Confirm Payment</h3>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </section>--}}
{{--                    </div>--}}
...
{{--                                {!! Form::open( ['route' => ['frontend.sample-collection.payment-confirmation'], 'method' => 'POST','class' =>'form-horizontal login', 'data-parsley-validate']) !!}--}}
{{--                                <li>Payment Amount : <strong>{!! $price !!} tk</strong></li>--}}
