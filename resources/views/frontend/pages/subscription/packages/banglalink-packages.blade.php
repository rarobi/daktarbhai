                                                                ...
                                                                @else
                                                                    @if(preg_match("/bl/", $plan->plan_slug))
                                                                        @if(isset($logged_in_api_user) && $logged_in_api_user->is_subscribed == false)
                                                                          <a href="{!! route('frontend.subscription.confirmation.blink', [$plan->plan_slug] ) !!}" class="btn-alt small buy-btn">{{__('packages.buttons.buy_now')}}</a>
                                                                        @endif
                                                                    @else
                                                                        <a href="{!! route('frontend.subscription.confirmation', [$plan->plan_slug] ) !!}" class="btn-alt small buy-btn">{{__('packages.buttons.buy_now')}}</a>
                                                                    @endif
