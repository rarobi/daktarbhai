        ...
        <div class="bhoechie-tab-content active">
            <div class="col-md-12 email-field">
                <div class="user-profile">
                    ...
                    <div class="col-md-12">
                        {!! Form::open(['url'=>'update/email-password','method'=>'post']) !!}
                        <div class="form-group">
                            {!! Form::label('email_verification_code','Enter Your Verification Code Here') !!}
                            {!! Form::text('email_verification_code','',['class'=>'form-control','required'=> 'required']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('email','Email Id') !!}
                            <input type="text" value="{{ $email }}" name="" disabled>
                            <input type="hidden" value="{{ $email }}" name="email">
{{--                            {!! Form::text('email',{{ (session('email') }}, ['class'=>'form-control', 'disabled'=>'disabled']) !!}--}}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group pull-right col-md-4 email-submit">
                            <button type="submit" class="btn btn-block submit-email">Submit</button>
                        </div>
                        {!! Form::close() !!}
